...
Este repositório contém o código-fonte integral, esquemáticos e a documentação técnica da arquitetura ciber-física baseada em **Radio Data System (RDS)** para controle remoto de semáforos, apresentada no Simpósio Brasileiro de Sistemas Multimídia e Web (WebMedia).
...
**Receptor (RX):**
- 1x Microcontrolador ESP8266 (NodeMCU ou Wemos D1 Mini)
- 1x Módulo Receptor FM Si4703 (SparkFun)
- 1x Módulo Semáforo LED (ou LEDs discretos: Verde, Amarelo e Vermelho)
...
Ambos os módulos de rádio utilizam o barramento **I2C**. Conecte conforme a tabela:
